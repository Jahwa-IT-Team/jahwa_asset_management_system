...
class CardSettingsCustomText extends FormField<String>
    implements CommonCardFieldAttributes {
  CardSettingsCustomText({
    Key key,
    String initialValue,
    ...
    this.showClearButtonIOS = OverlayVisibilityMode.never,
        ...
        super(
          ...
          builder: (FormFieldState<String> field) =>
              (field as _CardSettingsCustomTextState)._build(field.context),
        );
  final bool readOnly;
  ...
  @override
  _CardSettingsCustomTextState createState() => _CardSettingsCustomTextState();
}

class _CardSettingsCustomTextState extends FormFieldState<String> {
  TextEditingController _controller;

  @override
  CardSettingsCustomText get widget => super.widget as CardSettingsCustomText;
  ...
  @override
  void didUpdateWidget(CardSettingsCustomText oldWidget) {
