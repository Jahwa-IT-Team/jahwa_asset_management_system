  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => FacilityTradeCommonRepository(),
        ),
        ChangeNotifierProvider(
          create: (_) => FacilityTradeRequestRepository(),
        ),
        ChangeNotifierProvider(
          create: (_) => FacilityTradeSendRepository(),
        ),
        ChangeNotifierProvider(
          create: (_) => FacilityTradeReceiveRepository(),
        ),
        ChangeNotifierProvider(
